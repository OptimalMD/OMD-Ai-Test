						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									...
									{#if $config?.features?.enable_version_update_check}
										<a
											href="https://github.com/open-webui/optimalmd-ai/releases/tag/v{version.latest}"
											target="_blank"
										>
											{updateAvailable === null
					...
					<div class="mb-2.5">
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use OptimalMD AI and seek support from the community.')}
								</div>
							</div>

							<a
								class="flex-shrink-0 text-xs font-medium underline"
								href="https://docs.OptimalMD AI.com/"
								target="_blank"
							>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								...
								<a href="https://twitter.com/OptimalMD AI" target="_blank">
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/twitter/follow/OptimalMD AI"
									/>
								</a>

								<a href="https://github.com/open-webui/optimalmd-ai" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/open-webui/optimalmd-ai?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a
										href="https://docs.OptimalMD AI.com/enterprise"
										target="_blank"
						...
						{#if adminConfig?.ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2 mb-2.5">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://docs.OptimalMD AI.com/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://docs.OptimalMD AI.com/getting-started/api-endpoints"
										target="_blank"
							...
							<div class="mt-2 text-xs">
								...
								>
									<div>
										...
										<span
											><a
												href="https://docs.OptimalMD AI.com/getting-started/env-configuration#jwt_expires_in"
												target="_blank"
												class=" underline"
