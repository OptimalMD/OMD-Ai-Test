...
# BASE_DIR is the parent of BACKEND_DIR (optimalmd-ai-dev/)
...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "OptimalMD AI")
if WEBUI_NAME != "OptimalMD AI":
    WEBUI_NAME += " (OptimalMD AI)"

WEBUI_FAVICON_URL = "https://OptimalMD AI.com/favicon.png"
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("optimalmd-ai")}
else:
    try:
...
REDIS_KEY_PREFIX = os.environ.get("REDIS_KEY_PREFIX", "optimalmd-ai")
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "optimalmd-ai")
